window.onload = function(){
  var ordenDelUsuario;
  var ordenDelUsuario3;
  var ordenDelUsuario1;
  var ordenDelUsuario2;
  var numeroDePagina = 1
  var verMas = document.querySelector(".ver-masB")
  console.log(verMas);
  ...
  document.querySelector('.ba').onsubmit = function(e) {
    ...
    ordenDelUsuario = campoOrden.options[campoOrden.selectedIndex].value;
    console.log(ordenDelUsuario)

    var campoOrden1 = document.querySelector("select[name='selectOrder1']")
    ordenDelUsuario1 = campoOrden1.options[campoOrden1.selectedIndex].value;

    var campoOrden2 = document.querySelector("select[name='selectOrder2']")
    ordenDelUsuario2 = campoOrden2.options[campoOrden2.selectedIndex].value;

    var campoOrden3 = document.querySelector("select[name='selectOrder3']")
    ordenDelUsuario3 = campoOrden3.options[campoOrden3.selectedIndex].value;
    ...
    fetch("https://api.themoviedb.org/3/discover/tv?api_key=9901ee414425659325dc091c288e33c9&language=en-US&sort_by=" + ordenDelUsuario + "&first_air_date_year="+ ordenDelUsuario3 + "&page=1&timezone=America%2FNew_York&with_genres="+ ordenDelUsuario1 + "&without_genres="+ ordenDelUsuario2 + "&include_null_first_air_dates=false&page=" + numeroDePagina)
    .then(function(response) {
      return response.json();
    })
    .then(function(respuesta) {
      ...
      document.querySelector(".scroll-vermas").style.display = "flex";
